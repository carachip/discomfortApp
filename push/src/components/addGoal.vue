  ...
  <div class="absolute left-0 top-0 bg-blue w-full h-full">
    <div class="flex flex-col bg-blue-light m-4" style="height: calc(100% - 2rem)">
        ...
        <div class="p-3 overflow-y-auto">
            <div class="flex font-bold">Goal Info</div>
            ...
            <div class="flex font-bold border-t border-blue mt-1">Goal Reward</div>
...
export default {
  ...
  methods: {
      ...
      validateAndSave: function() {
          if (this.title == "" || this.chosenPartner == "" || (this.reminder && this.reminderFreq == "") || (this.repeat && this.repeatFreq == "") || this.rewardMsg == "") {
              this.errors = true;
          }
          else {
              this.close();
